...
<script type="text/javascript">
    ...
    $(function(){
        ...
        //         alert($("#"+name).val());
        //         $.cookie(<?php echo $number; ?>+name,$("#"+name).val(),{experies:7});
        //     });
        // };
// var id_array=["name","sex","education","degree","native","politics","professional","employer","unit","duty","team"];
       ...
       $("#name").bind('input propertychange',function(){
        ...
        $("#sex").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"sex",$("#sex").val(),{experies:7});
        });

        $("#education").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"education",$("#education").val(),{experies:7});
        });

        $("#degree").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"degree",$("#degree").val(),{experies:7});
        });

        $("#native").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"native",$("#native").val(),{experies:7});
        });

        $("#birthday").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"birthday",$("#birthday").val(),{experies:7});
        });

        $("#politics").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"politics",$("#politics").val(),{experies:7});
        });

        $("#professional").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"professional",$("#professional").val(),{experies:7});
        });

        $("#employer").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"employer",$("#employer").val(),{experies:7});
        });

        $("#unit").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"unit",$("#unit").val(),{experies:7});
        });

        $("#duty").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"duty",$("#duty").val(),{experies:7});
        });

        $("#team").bind('input propertychange',function(){
            $.cookie(<?php echo $number; ?>+"team",$("#team").val(),{experies:7});
        });
