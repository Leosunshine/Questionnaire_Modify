    ...
    <div class="baseinfo" style="width:100%;height:100%;overflow:auto;">
        ...
        <table border="1" style="line-height:33px; margin:0 auto; font-size:16px; font-family:'微软雅黑'">
            <tr>
                ...
                <td style="width:180px;">&nbsp;<?php echo $name; ?></td>
                <td style="width:120px;font-size:14px;">&nbsp;性别</td>
                <td style="width:180px;">&nbsp;<?php echo $sex; ?></td></tr>
            <tr>
                <td style="width:120px;font-size:14px;">&nbsp;学历</td>
                <td style="width:180px;">&nbsp;<?php echo $education; ?></td>
                <td style="width:120px;font-size:14px;">&nbsp;学位</td>
                <td style="width:180px;">&nbsp;<?php echo $degree; ?></td></tr>
            <tr>
                <td style="width:120px;font-size:14px;">&nbsp;出生年月</td>
                <td style="width:180px;">&nbsp;<?php echo $birthday; ?></td>
                <td style="width:120px;font-size:14px;">&nbsp;籍贯</td>
                <td style="width:180px;">&nbsp;<?php echo $native; ?></td></tr>
            <tr>
                <td style="width:120px;font-size:14px;">&nbsp;政治面貌</td>
                <td style="width:180px;">&nbsp;<?php echo $politics; ?></td>
                <td style="width:120px;font-size:14px;">&nbsp;职称</td>
                <td style="width:180px;">&nbsp;<?php echo $professional; ?></td></tr>
            <tr><td style="width:120px;font-size:14px;">&nbsp;工作单位</td>
                <td colspan="3" style="width:180px;">&nbsp;<?php echo $employer; ?></td></tr>
            <tr><td style="width:120px;font-size:14px;">&nbsp;部门</td>
                <td colspan="3" style="width:180px;">&nbsp;<?php echo $unit; ?></td></tr>
            <tr><td style="width:120px;font-size:14px;">&nbsp;职务</td>
                <td colspan="3" style="width:180px;">&nbsp;<?php echo $duty; ?></td></tr>
            <tr><td style="width:120px;font-size:14px;">&nbsp;班子/系统</td>
                <td colspan="3" style="width:180px;">&nbsp;<?php echo $team; ?></td></tr>
        </table>
...
<script type="text/javascript">
    var education = <?php echo $other; ?>.education;
    var work = <?php echo $other; ?>.work;
